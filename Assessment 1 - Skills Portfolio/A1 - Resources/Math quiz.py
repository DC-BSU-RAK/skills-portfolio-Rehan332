...
# ---------------------------
# Get correct folder path of this file (so images always load)
# ---------------------------
BASE_DIR = os.path.dirname(os.path.abspath(__file__))  # VERY IMPORTANT
...
# ---------------------------
# Utility: load background safely from same folder
# ---------------------------
def load_bg(filename, size=(800, 520)):
    filepath = os.path.join(BASE_DIR, filename)  # FULL correct path
...
# Load images (names must be EXACTLY this in folder)
